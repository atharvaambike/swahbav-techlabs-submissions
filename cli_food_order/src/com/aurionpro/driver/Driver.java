...
public class Driver {
	...
	static List<ICuisine> cuisines = Arrays.asList(new IndianCuisine(), new ItalianCuisine(), new JapaneseCuisine(),
			new MexicanCuisine());

	static FoodManager foodManager = new FoodManager(cuisines);
	static MenuService menuService = new MenuService(foodManager);

	static DiscountConfig discountConfig = new DiscountConfig(500, 50);
	static DeliveryPartnerManager deliveryManager = new DeliveryPartnerManager(
